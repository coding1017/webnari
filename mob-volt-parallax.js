...
(function(){
  ...
  var stickyEl = seqEl;
  if(seqEl){
    var bg = document.getElementById('mv-seqBg');
    var panelContainer = document.getElementById('mv-panelContainer');
    var panelGlow = document.getElementById('mv-panelGlow');
    var panelEnergize = document.getElementById('mv-panelEnergize');
    var panelHud = document.getElementById('mv-panelHud');
    var panelPowered = document.getElementById('mv-panelPowered');
    var hudCircuits = document.getElementById('mv-hudCircuits');
    var intro = document.getElementById('mv-seqIntro');
    var phaseEl = document.getElementById('mv-seqPhase');
    var scrubFill = document.getElementById('mv-seqScrubFill');
    var finalEl = document.getElementById('mv-seqFinal');
    var svg = document.getElementById('mv-panelSvg');
    ...
    var coverMask = svgEl('mask',{id:'mv-deadFrontMask'});
    ...
    gCover.appendChild(svgEl('rect',{x:28,y:55,width:424,height:660,rx:4,fill:'#3A3C42',stroke:'#555','stroke-width':1.2,mask:'url(#mv-deadFrontMask)'}));
