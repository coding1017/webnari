// Desktop RoofPro Parallax — namespaced IDs (dr-*), timer-driven progress
(function(){
  "use strict";
  ...
  window.__deskRoofProgress = 0.15;

  var seqEl=document.getElementById('dr-hero'), stickyEl=document.getElementById('dr-seqSticky');
  if(seqEl&&stickyEl){
    var bg=document.getElementById('dr-seqBg');
    var sceneContainer=document.getElementById('dr-sceneContainer');
    var sceneGlow=document.getElementById('dr-sceneGlow');
    var sceneEnergize=document.getElementById('dr-sceneEnergize');
    var sceneHud=document.getElementById('dr-sceneHud');
    var scenePowered=document.getElementById('dr-scenePowered');
    var intro=document.getElementById('dr-seqIntro');
    var phaseEl=document.getElementById('dr-seqPhase');
    var scrubFill=document.getElementById('dr-seqScrubFill');
    var finalEl=document.getElementById('dr-seqFinal');
    var svg=document.getElementById('dr-sceneSvg');
    var ns='http://www.w3.org/2000/svg';

    function getProgress(){return window.__deskRoofProgress;}
    var lastPhase='';
    ...
    // Power lights
    var powerLights=[];
    for(var pli=1;pli<=6;pli++){var plEl=document.getElementById('dr-pl'+pli);if(plEl)powerLights.push(plEl);}
