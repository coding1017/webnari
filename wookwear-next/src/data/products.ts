...
export const products: Product[] = [
  ...
  },
  {
    ...
    variants: [
      ...
      { id: 'buddy-mat-E-paisley', name: 'E - Paisley Mix', color: '#A855F7', imgs: ['/images/buddy-mats-1.jpg'], price: 42, inStock: true },
      { id: 'buddy-mat-F-green-checker', name: 'F - Green Checker', color: '#0D9488', imgs: ['/images/buddy-mats-1.jpg'], price: 42, inStock: true },
    ],
  },
  {
  ...
  },
  {
    ...
    isCollection: true,
    variants: [
      { id: 'pouch-A-teal-checker', name: 'A - Teal Checker', color: '#0D9488', imgs: ['/images/pouch-A-1.jpg', '/images/pouch-A-2.jpg'], price: 38, inStock: true },
      { id: 'pouch-B-maroon-checker', name: 'B - Maroon Checker', color: '#9F1239', imgs: ['/images/pouch-B-1.jpg', '/images/pouch-B-2.jpg'], price: 38, inStock: false },
      { id: 'pouch-C-coral-hex', name: 'C - Coral Honeycomb', color: '#F97316', imgs: ['/images/pouch-C-1.jpg', '/images/pouch-C-2.jpg'], price: 38, inStock: true },
      { id: 'pouch-D-purple-swirl', name: 'D - Purple Kaleidoscope', color: '#7C3AED', imgs: ['/images/pouch-D-1.jpg', '/images/pouch-D-2.jpg'], price: 38, inStock: false },
      { id: 'pouch-E-green-checker', name: 'E - Green Checker', color: '#22C55E', imgs: ['/images/pouch-E-1.jpg', '/images/pouch-E-2.jpg'], price: 38, inStock: true },
      { id: 'pouch-F-pink-swirl', name: 'F - Pink Marble', color: '#EC4899', imgs: ['/images/pouch-F-1.jpg'], price: 38, inStock: false },
      { id: 'pouch-G-green-abstract', name: 'G - Green Abstract', color: '#16A34A', imgs: ['/images/pouch-G-1.jpg', '/images/pouch-G-2.jpg'], price: 40, inStock: true },
    ],
  },
  {
