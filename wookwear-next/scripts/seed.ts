...
const products = [
  ...
  { id: "collection-pouches-spring", name: "Spring Prized Possession Drop", category: "pouches", price: 3800, badge: "collection", in_stock: true, description: "Happy #wookwearwednesday! Prized possession pouches made with some of my favorite fabrics.", is_collection: true, sort_order: 6, rating: 4.8, review_count: 6, imgs: ["/images/pouches-circle-1.jpg"], reviews: [{ name: "ewokglass", text: "Fire fire fire! Every color is a winner.", rating: 5, date: "2025-05-07" }], variants: [{ id: "pouch-A-teal-checker", name: "A - Teal Checker", color: "#0D9488", imgs: ["/images/pouch-A-1.jpg", "/images/pouch-A-2.jpg"], price: 3800, in_stock: true }, { id: "pouch-B-maroon-checker", name: "B - Maroon Checker", color: "#9F1239", imgs: ["/images/pouch-B-1.jpg", "/images/pouch-B-2.jpg"], price: 3800, in_stock: false }, { id: "pouch-C-coral-hex", name: "C - Coral Honeycomb", color: "#F97316", imgs: ["/images/pouch-C-1.jpg", "/images/pouch-C-2.jpg"], price: 3800, in_stock: true }, { id: "pouch-D-purple-swirl", name: "D - Purple Kaleidoscope", color: "#7C3AED", imgs: ["/images/pouch-D-1.jpg", "/images/pouch-D-2.jpg"], price: 3800, in_stock: false }, { id: "pouch-E-green-checker", name: "E - Green Checker", color: "#22C55E", imgs: ["/images/pouch-E-1.jpg", "/images/pouch-E-2.jpg"], price: 3800, in_stock: true }, { id: "pouch-F-pink-swirl", name: "F - Pink Marble", color: "#EC4899", imgs: ["/images/pouch-F-1.jpg"], price: 3800, in_stock: false }, { id: "pouch-G-green-abstract", name: "G - Green Abstract", color: "#16A34A", imgs: ["/images/pouch-G-1.jpg", "/images/pouch-G-2.jpg"], price: 4000, in_stock: true }] },
