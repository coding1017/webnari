// Desktop GreenScape Parallax — namespaced IDs (dg-*), timer-driven progress
(function(){
  "use strict";
  ...
  window.__deskGreenProgress = 0.15;

  var seqEl = document.getElementById('dg-hero');
  var stickyEl = seqEl;
  if(seqEl){
    var bg=document.getElementById('dg-seqBg');
    var sceneContainer=document.getElementById('dg-sceneContainer');
    var sceneGlow=document.getElementById('dg-sceneGlow');
    var sceneEnergize=document.getElementById('dg-sceneEnergize');
    var sceneHud=document.getElementById('dg-sceneHud');
    var scenePowered=document.getElementById('dg-scenePowered');
    var hudStep=document.getElementById('dg-hudStep');
    var intro=document.getElementById('dg-seqIntro');
    var phaseEl=document.getElementById('dg-seqPhase');
    var scrubFill=document.getElementById('dg-seqScrubFill');
    var finalEl=document.getElementById('dg-seqFinal');
    var svg=document.getElementById('dg-sceneSvg');
    var ns='http://www.w3.org/2000/svg';

    function getProgress(){return window.__deskGreenProgress;}
    var lastPhase='';
    ...
    // Power lights
    var powerLights=[];
    for(var pli=1;pli<=6;pli++){var plEl=document.getElementById('dg-pl'+pli);if(plEl)powerLights.push(plEl);}
