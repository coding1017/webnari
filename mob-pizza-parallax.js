// Mobile Pizza Parallax — namespaced IDs (mp-*), timer-driven progress
(function(){
  "use strict";
  ...
  window.__mobPizzaProgress = 0.15;

  var seqEl = document.getElementById('mp-hero');
  var stickyEl = seqEl;
  if(seqEl){
    var bg = document.getElementById('mp-seqBg');
    var sceneGlow = document.getElementById('mp-sceneGlow');
    var sceneEnergize = document.getElementById('mp-sceneEnergize');
    var scenePowered = document.getElementById('mp-scenePowered');
    var intro = document.getElementById('mp-seqIntro');
    var phaseEl = document.getElementById('mp-seqPhase');
    var scrubFill = document.getElementById('mp-seqScrubFill');
    var finalEl = document.getElementById('mp-seqFinal')||{style:{},classList:{add:function(){},remove:function(){}}};
    var svg = document.getElementById('mp-sceneSvg');
    var ns = 'http://www.w3.org/2000/svg';

    function getProgress(){return window.__mobPizzaProgress;}
    ...
    var gMarble = svgEl('linearGradient',{id:'mp-marbleGrad',x1:'0',y1:'0',x2:'0.3',y2:'1'});
    ...
    var gDough = svgEl('radialGradient',{id:'mp-doughGrad',cx:'45%',cy:'40%',r:'55%'});
    ...
    // Crust rim gradient
    var gRim = svgEl('radialGradient',{id:'mp-rimGrad',cx:'50%',cy:'50%',r:'50%'});
    ...
    // Sauce gradient
    var gSauce = svgEl('radialGradient',{id:'mp-sauceGrad',cx:'45%',cy:'42%',r:'55%'});
    ...
    // Mozzarella gradient
    var gMozz = svgEl('radialGradient',{id:'mp-mozzGrad',cx:'40%',cy:'35%',r:'60%'});
    ...
    // Pepperoni gradient
    var gPep = svgEl('radialGradient',{id:'mp-pepGrad',cx:'45%',cy:'40%',r:'55%'});
    ...
    // Wood gradient (peel)
    var gWood = svgEl('linearGradient',{id:'mp-woodGrad',x1:'0',y1:'0',x2:'0.1',y2:'1'});
    ...
    // Rolling pin wood
    var gPin = svgEl('linearGradient',{id:'mp-pinGrad',x1:'0',y1:'0',x2:'0',y2:'1'});
    ...
    // Oven interior
    var gOvenInt = svgEl('radialGradient',{id:'mp-ovenInterior',cx:'50%',cy:'60%',r:'60%'});
    ...
    // Pan gradient
    var gPan = svgEl('linearGradient',{id:'mp-panGrad',x1:'0',y1:'0',x2:'1',y2:'1'});
    ...
    var gCooked = svgEl('radialGradient',{id:'mp-cookedGrad',cx:'50%',cy:'50%',r:'50%'});
    ...
    var gSteel = svgEl('linearGradient',{id:'mp-steelGrad',x1:'0',y1:'0',x2:'1',y2:'1'});
    ...
    // Flame gradient
    var gFlame = svgEl('linearGradient',{id:'mp-flameGrad',x1:'0',y1:'1',x2:'0',y2:'0'});
    ...
    // Glow filter
    var fGlow = svgEl('filter',{id:'mp-glow',x:'-50%',y:'-50%',width:'200%',height:'200%'});
    ...
    gSlab.appendChild(svgEl('rect',{x:slabX,y:slabY,width:slabW,height:slabH,rx:10,fill:'url(#mp-marbleGrad)',stroke:'#C0B8B0','stroke-width':1.5}));
    // Marble veins
    var veins=[
    ...
    // Main ball
    gDoughBall.appendChild(svgEl('circle',{cx:cx,cy:cy,r:ballR,fill:'url(#mp-doughGrad)',stroke:'#D4C090','stroke-width':1}));
    // Surface fold lines
    var folds=[
    ...
    // Main cylinder
    gPin_g.appendChild(svgEl('rect',{x:pinX,y:pinY-pinH/2,width:pinW,height:pinH,rx:pinH/2,fill:'url(#mp-pinGrad)',stroke:'#7A4A2A','stroke-width':1}));
    // Highlight strip
    ...
    // Main disc
    gDisc.appendChild(svgEl('circle',{cx:cx,cy:cy,r:pizzaR,fill:'url(#mp-doughGrad)',stroke:'#D4C090','stroke-width':1}));
    // Raised rim
    ...
    var sauceCircle = svgEl('circle',{cx:cx,cy:cy,r:sauceR,fill:'url(#mp-sauceGrad)',opacity:0.95});
    ...
    for(var mzi=0;mzi<mozzCount;mzi++){
      ...
      mzPath += ' Z';
      mzg.appendChild(svgEl('path',{d:mzPath,fill:'url(#mp-mozzGrad)',stroke:'#E8E0D0','stroke-width':0.5}));
    ...
    for(var ppi=0;ppi<pepCount;ppi++){
      ...
      // Main slice
      ppg.appendChild(svgEl('circle',{cx:ppx,cy:ppy,r:ppR,fill:'url(#mp-pepGrad)',stroke:'#5A0000','stroke-width':0.8}));
      // Fat specks
    ...
    // Paddle
    gPeel.appendChild(svgEl('rect',{x:peelX,y:peelY,width:peelW,height:peelH,rx:20,fill:'url(#mp-woodGrad)',stroke:'#A08030','stroke-width':1.5}));
    // Wood grain
    ...
    for(var ofi=0;ofi<ovenFlameCount;ofi++){
      ...
      var oflame = svgEl('path',{d:ofPath,fill:'url(#mp-flameGrad)',opacity:0.85});
    ...
    for(var offi=0;offi<floorFlameCount;offi++){
      ...
      var offl = svgEl('path',{d:offPath,fill:'url(#mp-flameGrad)',opacity:0.7});
    ...
    gCooked_g.appendChild(svgEl('circle',{cx:cx,cy:cy,r:pizzaR,fill:'url(#mp-cookedGrad)',stroke:'#8B6914','stroke-width':1.5}));
    ...
    gPanEl.appendChild(svgEl('circle',{cx:cx,cy:cy,r:panR,fill:'url(#mp-panGrad)',stroke:'#808080','stroke-width':2}));
    ...
    var sliceHolePath = 'M'+cx+' '+cy+
      ...
      ' Z';
    var gSliceHole = svgEl('path',{d:sliceHolePath,fill:'url(#mp-panGrad)',opacity:0});
    svg.appendChild(gSliceHole);

    // ─── 14. PIZZA CUTTER ───
    var gCutter = svgEl('g',{opacity:0});
    var cutterX = cx, cutterY = cy-pizzaR-50;
    gCutter.appendChild(svgEl('circle',{cx:cutterX,cy:cutterY,r:18,fill:'url(#mp-steelGrad)',stroke:'#888','stroke-width':1}));
    ...
    gSlice.appendChild(svgEl('path',{d:slicePath,fill:'url(#mp-cookedGrad)',stroke:'#8B6914','stroke-width':1.5}));
    ...
    function update(){
      ...
      var pls2=[document.getElementById('mp-pl1'),document.getElementById('mp-pl2'),document.getElementById('mp-pl3'),document.getElementById('mp-pl4'),document.getElementById('mp-pl5'),document.getElementById('mp-pl6')];
      ...
      if(p>=0.87&&p<0.95){
        ...
        var pls=[document.getElementById('mp-pl1'),document.getElementById('mp-pl2'),document.getElementById('mp-pl3'),document.getElementById('mp-pl4'),document.getElementById('mp-pl5'),document.getElementById('mp-pl6')];
